...
def generate_command(
    ...
    use_history: bool = typer.Option(
        False, "--history", "-h", help="Use command history for context"
    ),
    execute: bool = typer.Option(
        False, "--execute", "-e", help="Execute the generated command"
    ),
    advanced: bool = typer.Option(
        False, "--advanced", "-a", help="Use advanced prompt for command generation"
    ),
):
